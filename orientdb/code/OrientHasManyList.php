 ...
 * @subpackage model
 */
class OrientHasManyList extends OrientRelationList {
	...
	protected function foreignIDFilter($id = null) {
		...
		if(is_array($id)) {
			return "{$this->foreignKey} IN ['" . implode("', '", array_map('Convert::raw2sql', $id)) . "']";
		} else if($id !== null){
			return "{$this->foreignKey} = '" . Convert::raw2sql($id) . "'";
		}
	}
